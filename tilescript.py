...
dictionary = {
    'f': (_resources.load_directory("tex/floor"), 0, None, None, True, False),
    'start': (None, 0, None, __effect_on_set_player, False, True),
    'w': (_resources.load_directory("tex/wall"), 999, None, None, True, False),
    'key': ((_resources.load_img("tex/key.png"),), -3, __effect_key, __effect_on_set_key, False, True),
    'end': ((_resources.load_img("tex/door.png"),), 0, __effect_win, __effect_on_set_end, False, True),
    'trap': ((_resources.load_img("tex/trap.png"),), 2, __effect_damage_light, None, True, False)
}
